...
const Page = () => {
  ...
  return (
    <div className={styles.container}>
      <Sidebar />
      <main className={`${styles.mainContent} ${!firstQuery ? styles.chatActive : ''}`}>
            ...
            <>
              <div className={styles.chatContainer}>
                <div className={`${styles.message} ${styles.fadeInMessage}`}>
                  ...
                  <div className={styles.messageContent}>
                    <div className={styles.messageText}>
                      Hello! I'm Kenley, your data insights assistant. How can I help you today?
                    </div>
                    <div className={styles.messageTimestamp}>{formatTime(new Date().toISOString())}</div>
                  </div>
                </div>
                ...
                {messages.map((message, index) => (
                  <div 
                    key={message.id} 
                    className={`${styles.message} ${message.sender === 'user' ? styles.userMessage : ''} ${styles.fadeInMessage}`}
              ...
              <div className={styles.inputContainer}>
                <div className={styles.inputControlsWrapper}>
                  ...
                  <div className={styles.sendButtonContainer}>
                    <button 
                      className={`${styles.sendButton} ${!inputValue.trim() ? styles.sendButtonDisabled : ''}`}
                      onClick={handleSendMessage}
                      disabled={!inputValue.trim()}
                    >
                      <IoMdArrowUp />
